...
$sql = "SELECT os.id_os, os.numero_os, os.status, os.data_abertura,
               os.descricao_problema, os.km_entrada,
...
$mensagens = [
    ...
    'nao_pode_editar' => ['texto' => 'Só quem abriu a OS ou o admin pode editá-la.', 'tipo' => 'erro'],
];
...
<div class="admin-bloco">
    <form method="GET" class="admin-barra-acoes" id="formBuscaOS">
        ...
        <a href="ordens_novo.php" class="admin-btn admin-btn-novo">
                ...
                <?php foreach ($ordens as $os): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <br>
                            <small style="color: var(--mtech-text-muted);">
                        ...
                        <td>
                            <span class="admin-badge <?php echo classeStatus($os['status']); ?>">
                                <?php echo nomeStatus($os['status']); ?>
                            </span>
                        </td>
